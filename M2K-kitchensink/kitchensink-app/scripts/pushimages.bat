...
echo "pushing image kitchensink"
%CONTAINER_RUNTIME% tag kitchensink %REGISTRY_URL%/%REGISTRY_NAMESPACE%/kitchensink
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/kitchensink
